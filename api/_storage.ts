type Monument = {
  ...
  dynasty?: string;
  primaryModel?: string;
  historicalModels?: Record<string, string>;
  facts?: string[];
...
const monumentsData: Monument[] = [
  ...
  },
  {
    ...
    description:
      "The Red Fort is a historic fort in the city of Delhi that served as the main residence of the Mughal Emperors. Built in 1639 by the fifth Mughal Emperor Shah Jahan, the fort represents the peak of Mughal architecture.",
    yearBuilt: "1639-1648",
    dynasty: "Mughal",
  ...
  },
  {
    ...
    description:
      "The Qutub Minar is a minaret and victory tower that forms part of the Qutub complex. It is a UNESCO World Heritage Site in the Mehrauli area of Delhi, India. The tower is 73 meters tall.",
    yearBuilt: "1192-1220",
    dynasty: "Mamluk",
...
class MemStorage {
  ...
  monuments: Monument[] = monumentsData;
  visits: any[] = [];
  currentId = 1;
  visitId = 1;
  ...
  async recordMonumentVisit(monumentId: string) {
    const visit = {
      id: this.visitId++,
      monumentId,
      visitDate: new Date(),
