...
function App() {
  ...
  const isScrollablePage = location === "/timeline" || location === "/festivals";
  ...
  return (
    <AppProvider>
      <KeyboardControls map={controls}>
        <div className={`${isScrollablePage ? 'overflow-y-auto bg-slate-950' : 'overflow-hidden'} h-[100dvh] w-screen relative`}>
          ...
          <main className={`w-full ${isScrollablePage ? '' : 'h-full'}`}>
            <Switch>
